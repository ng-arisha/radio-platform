...
import { getStationTransactionsForCs } from "@/lib/finance/finance";
...
function Customertxtions() {
  ...
  const showTransactions = useSelector(
    (state: RootState) => state.finance.cstransactions
  );
...
export default Customertxtions
