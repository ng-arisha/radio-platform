...
function UserStats() {
  ...
  const totalUsers =
    ...
    (stationAdminUsers?.length || 0) +
    (presenterUsers?.length || 0);
  const allUsers = [
    ...(mediahouseUsers || []),
    ...(stationAdminUsers || []),
    ...(presenterUsers || []),
  ...
  const distributionData = [
    {
      ...
      value: mediahouseUsers?.length || 0,
      color: "#8b5cf6",
    },
    {
      name: "Station Admins",
      value: stationAdminUsers?.length || 0,
      color: "#3b82f6",
    },
    {
      name: "Presenters",
      value: presenterUsers?.length || 0,
      color: "#10b981",
    },
  ];
