...
import { setStationCommissionRate } from "@/lib/commission/commission";
...
function AssignStationCommissionRate({ item }: { item: ShowCommissionType }) {
    ...
    const handleUpdateRate = async () => {
      ...
      await dispatch(setStationCommissionRate(data));
      closeModal();
    };
    return (
        <div>
        ...
        <div className="modal-box">
          <div className="flex justify-between items-center mb-4">
            <h1 className="text-gray-200 text-xl font-medium">
              Modify commission rate for {item.showName}
            </h1>
            <button
              onClick={closeModal}
...
export default AssignStationCommissionRate
