...
import { masterSetMediaHouseCommissionRate } from "@/lib/commission/commission";
...
function MasterSetCommissionRate({ item }: { item: MediaHouseCommissionType }) {
  ...
  const handleUpdateRate = async () => {
    ...
    await dispatch(masterSetMediaHouseCommissionRate(data));
    closeModal();
  };
        ...
        <div className="modal-box">
          <div className="flex justify-between items-center mb-4">
            <h1 className="text-gray-200 text-xl font-medium">
              Modify commission rate for {item.mediaHouseName}
            </h1>
            <button
              onClick={closeModal}
...
export default MasterSetCommissionRate;
